...
// Variables
// En php, on ne déclare le type (entier, chaîne) de variable

//*** Types simples ***
$message = "Le PHP c'est formidable"; //chaîne de caractère, string
echo $message;
...
// Tableau associatif (pas la même chose qu'en js, il faut utiliser la structure objet)
...
$joueur = [
    ...
    //association 'clé'=>valeur, => est l'opératuer d'association
echo '<p>' . $joueur ['club'] . '</p>'; //renvoie Juventus
    //le . pour concaténer
    //echo nous envoi, on lui demande d'écoer. True équivaut à 1, false équivaut à 0.
/* foreach ($joueur['photos'] as $photo) {
        echo '<div><img src="img/joueurs/'.$photo.'.jpg"></div>';
 }*/

echo '<table class="table table-striped">';//bootstrap
